...
## Branch 생성
[원본 레포지토리](https://github.com/Konkuk-KUIT/KUIT6_Android) 에서 github 이름의 branch 를 입력합니다.
...
## 저장소 Fork
1. [원본 레포지토리](https://github.com/Konkuk-KUIT/KUIT6_Android) 에서 **Fork** -> **Create a new fork** 를 클릭합니다.
...
3. 실행 후 다음과 같이 커맨드를 입력합니다.
   - `git clone https://github.com/{본인 github id}/KUIT6_Android.git`
   - ex) `git clone https://github.com/ikseong00/KUIT6_Android.git`
