...
fun GetCouponItem(modifier: Modifier = Modifier) {
    ...
    LazyRow (
        ...
        item {
            Image(
                painter = painterResource(id = R.drawable.img_twi),
                contentDescription = "omg_twinkle",
        ...
        item{
            Button(
                modifier = modifier
                    .padding(top = 5.dp, end = 7.dp, bottom = 8.dp, start = 44.dp),
                onClick = { isWhite = !isWhite },
                colors = ButtonDefaults.buttonColors(containerColor =  Color(0xFF02AFFE),contentColor = if(isWhite) Color.White else Color.Black),
