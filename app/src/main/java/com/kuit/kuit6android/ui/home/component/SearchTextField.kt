...
fun SearchTextField(modifier: Modifier = Modifier) {
    ...
    Row(
        ...
        Icon(painter = painterResource(id = R.drawable.ic_search), contentDescription = "search", modifier = modifier.size(20.dp))
        OutlinedTextField(
            value = content,
            onValueChange = {content = it},
            placeholder = { Text(text = "이시헌님, 요아정 어때요?", fontSize = 15.sp) },
